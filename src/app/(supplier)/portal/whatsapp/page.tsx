...
export default function PortalWhatsAppPage() {
        ...
        <CardContent className="space-y-4">
          {connected ? (
            <div className="flex flex-col items-center gap-3 py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">המספר באוויר וההודעות יישלחו כרגיל.</p>
              <Link href="/portal">
                <Button className="mt-2">חזרה לפורטל</Button>
              </Link>
            </div>
          ) : (
            <>
              ...
              <div className="flex flex-col items-center justify-center gap-3 py-2">
                {qr.isLoading ? (
                  ...
                  <div className="rounded-lg border bg-white p-3">
                    <Image src={qr.data.base64} alt="WhatsApp QR" width={280} height={280} unoptimized />
                  </div>
                ) : (
