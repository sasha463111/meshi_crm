...
export const IMAGE_EDIT_PROMPTS: Record<ImageEditAction, string> = {
  ...
  white_background:
    'Place this bedding set (duvet, sheets and pillows) on a solid background of color #F4F3EF (warm off-white cream), like a professional ecommerce catalog product photo. Remove the room, furniture, floor, walls and all text. Neatly arrange the bedding so it is clearly visible, centered, with soft studio lighting and a subtle shadow. The entire background must be the color #F4F3EF. Output the edited image.',
}
